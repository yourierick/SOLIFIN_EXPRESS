        ...
        >
          ...
          >
            <TableHead>
              ...
              >
                <TableCell sx={{ width: { xs: "120px", sm: "140px" } }}>ID</TableCell>
                ...
                <TableCell sx={{ width: { xs: "120px", sm: "140px" } }}>Mise à jour</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
                ...
                >
                  ...
                  <TableCell>
                    <span className="font-medium">
                      {parseFloat(transaction.amount).toFixed(2)} {selectedCurrency === "USD" ? "$" : "FC"}
                    </span>
                  </TableCell>
                  <TableCell>
                    <span
