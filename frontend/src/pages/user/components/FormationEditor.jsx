          ...
          <Tabs
            ...
            sx={{
              "& .MuiTabs-indicator": {
                ...
                borderRadius: { xs: "4px 4px 0 0", sm: "3px 3px 0 0" },
                boxShadow: "0 2px 8px rgba(59, 130, 246, 0.3)",
              },
              "& .MuiTab-root": {
                ...
                textTransform: "none",
                borderRadius: { xs: "12px 12px 0 0", sm: "8px 8px 0 0" },
                transition: "all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",
                mx: { xs: 0.5, sm: 0 },
                my: { xs: 1, sm: 0.5 },
      ...
      <TabPanel value={tabValue} index={0}>
        ...
        >
          ...
          >
            ...
            >
              <LibraryBooksIcon
                sx={{ fontSize: { xs: 18, sm: 20 }, color: "white" }}
              />
            </Avatar>
            <Typography
          ...
          {(formation.status === "draft" ||
            ...
            <Button
              ...
              sx={{
                ...
                "&:active": {
                  transform: { xs: "translateY(0)", sm: "translateY(-1px)" },
                },
                "&::before": {
                  content: '""',
                  position: "absolute",
      ...
      <TabPanel value={tabValue} index={1}>
        ...
        {loadingStats ? (
          ...
          >
            ...
            <Typography variant="body2">
              Les statistiques seront disponibles une fois que des utilisateurs
              auront commencé à suivre votre formation.
            </Typography>
          </Alert>
        ) : (
          <Grid container spacing={3}>
      ...
      >
        ...
        <DialogActions>
          ...
          <Button
            ...
            startIcon={
              publishLoading ? <CircularProgress size={20} /> : <PublishIcon />
            }
          >
            ...
            <Box sx={{ display: "flex", alignItems: "center" }}>
              ...
              <Box>
                ...
                <Typography variant="body2" color="text.secondary">
                  Mettez à jour les détails de votre formation
                </Typography>
              </Box>
            </Box>
            <IconButton
        ...
        >
          ...
          >
            <Box sx={{ display: "flex", alignItems: "center" }}>
              <Avatar
                sx={{
                  bgcolor: editModule ? "info.main" : "primary.main",
                  mr: 2,
                  width: 40,
                  height: 40,
                  boxShadow: editModule
                    ? "0 4px 12px rgba(0, 184, 217, 0.3)"
                    : "0 4px 12px rgba(59, 130, 246, 0.3)",
                }}
              >
                {editModule ? (
