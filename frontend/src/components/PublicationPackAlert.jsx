...
const PublicationPackAlert = () => {
  const { isActive, canPublish, packInfo, loading } = usePublicationPack();
    ...
    return (
      <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-4">
        <div className="flex">
          ...
          <div className="ml-3">
            <p className="text-sm text-yellow-700">
              Votre compte ne peut pas publier de contenu, veuillez contacter le support pour plus d'information.
            </p>
          </div>
        </div>
      </div>
