    ...
    <div className="container mx-auto p-4 lg:p-6">
      ...
      <div className="mb-4 lg:mb-8">
        <div className="flex items-center space-x-2 sm:space-x-4 mb-3 sm:mb-4">
          ...
          <div className="flex-1">
            <h1 className="text-lg sm:text-xl lg:text-3xl font-bold text-gray-900 dark:text-white mb-1 sm:mb-2 bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400 bg-clip-text text-transparent">
              Gestion des utilisateurs et administrateurs
            </h1>
            <p className="text-xs sm:text-sm lg:text-base text-gray-600 dark:text-gray-400 max-w-2xl sm:max-w-3xl">
              Gérez les comptes utilisateurs et les permissions d'accès au
              système avec une interface moderne et intuitive.
            </p>
          </div>
          <Chip
            icon={<SparklesIcon className="h-3 w-3 sm:h-4 sm:w-4" />}
            label="Admin Panel"
            size="small"
            sx={{
              bgcolor: isDarkMode ? "#1f2937" : "#fff",
